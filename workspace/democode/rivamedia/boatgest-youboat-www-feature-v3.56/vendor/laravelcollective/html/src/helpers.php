...
if (! function_exists('link_to')) {
    ...
    function link_to($url, $title = null, $attributes = [], $secure = null)
    {
        ...
        return htmlspecialchars_decode(app('html')->link($url, $title, $attributes, $secure));
    }
}
...
if (! function_exists('link_to_action')) {
    ...
    {
        return htmlspecialchars_decode(app('html')->linkAction($action, $title, $parameters, $attributes));
    }
}
