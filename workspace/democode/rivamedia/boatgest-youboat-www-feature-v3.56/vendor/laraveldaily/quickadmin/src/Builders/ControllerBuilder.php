...
class ControllerBuilder
{
    ...
    private $namespace = 'App\Http\Controllers\BoatgestAdmin';
    ...
    private function publish($template)
    {
        ...
        file_put_contents(app_path('Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'Admin' . DIRECTORY_SEPARATOR . $this->fileName),
            $template);*/
        if (!file_exists(app_path('Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . camel_case(config('quickadmin.route'))))) {
            mkdir(app_path('Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . camel_case(config('quickadmin.route'))));
            chmod(app_path('Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . camel_case(config('quickadmin.route'))), 0777);
        }
        file_put_contents(app_path('Http' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . camel_case(config('quickadmin.route')) . DIRECTORY_SEPARATOR . $this->fileName),
            $template);
    }
