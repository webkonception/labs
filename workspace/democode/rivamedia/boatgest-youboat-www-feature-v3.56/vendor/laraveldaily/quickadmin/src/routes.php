                ...
                switch ($menu->menu_type) {
                    case 1:
                        Route::post(strtolower($menu->name) . '/massDelete', [
                            ...
                            'uses' => camel_case(config('quickadmin.route')) . '\\' . ucfirst(camel_case($menu->name)) . 'Controller@massDelete'
                        ]);
                        Route::resource(strtolower($menu->name),
                            //'Admin\\' . ucfirst(camel_case($menu->name)) . 'Controller');
                            camel_case(config('quickadmin.route')) . '\\' . ucfirst(camel_case($menu->name)) . 'Controller');
                        break;
                    case 3:
