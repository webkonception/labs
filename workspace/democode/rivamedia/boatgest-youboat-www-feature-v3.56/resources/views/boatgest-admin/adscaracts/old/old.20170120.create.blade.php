        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="alert alert-danger">
                    <ul class="row">
                        {!! implode('', $errors->all('<li class="error col-sm-6">:message</li>')) !!}
                    </ul>
                </div>
            </div>
        </div>
    @endif
    {!! Form::open(array('files' => true, 'route' => config('quickadmin.route') . '.adscaracts.store', 'id' => 'form-with-validation', 'role' => 'form', 'novalidate' => 'novalidate', 'files' => true, 'class' => 'form-horizontal')) !!}
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-12">
            ...
            $attributes = [
                    ...
                    'required' => 'required',
                    'id' => !empty($dealersusernames[$input_value]) ? 'dealerscaracts_name' : $input_name
            ];
            $css_state = '';
