...
@section('content')
    ...
    {!! Form::model($manufacturersengines, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'role'=>'form', 'method' => 'PATCH', 'route' => array(config('quickadmin.route') . '.manufacturersengines.update', $manufacturersengines->id))) !!}
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('name', old('name', $manufacturersengines->name), ['class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('rewrite_url', old('rewrite_url', $manufacturersengines->rewrite_url), ['class'=>'form-control']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('equivalent', old('equivalent', $manufacturersengines->equivalent), ['class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('referrer', old('referrer', $manufacturersengines->referrer), ['class'=>'form-control']) !!}
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('description', old('description', $manufacturersengines->description), ['class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-9 col-sm-8">
                        <div class="input-group">
                            {!! Form::text('position', old('position', $manufacturersengines->position), ['class'=>'form-control']) !!}
        ...
        <div class="form-group">
            <div class="col-sm-12 text-center">
                ...
                {!! htmlspecialchars_decode(link_to_route(config('quickadmin.route') . '.manufacturersengines.index', '<i class="fa fa-ban fa-fw"></i>' . ucfirst(trans('navigation.cancel')), [], ['class' => 'btn btn-default pull-right'])) !!}
            </div>
        </div>
