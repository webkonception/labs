...
@section('content')
    ...
    {!! Form::model($privatescaracts, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'role'=>'form', 'files'=>true, 'method' => 'PATCH', 'route' => array(config('quickadmin.route') . '.privatescaracts.update', $privatescaracts->id))) !!}
    {!! Form::hidden('user_id',$privatescaracts->user_id) !!}
    <section class="row well well-sm well-white">
        ...
        <div class="col-sm-6">
            <?php
            $user_status = !empty($privatescaracts->status) ? $privatescaracts->status : old('status', $privatescaracts->status);
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $denomination = old('denomination', isset($privatescaracts->denomination) ? $privatescaracts->denomination : '');
            ...
            <?php
            $firstname = old('firstname', isset($privatescaracts->firstname) ? $privatescaracts->firstname : '');
            ...
            <?php
            $name = old('name', isset($privatescaracts->name) ? $privatescaracts->name : '');
        ...
        <div class="col-sm-6">
            <?php
            $photo = old('photo', isset($privatescaracts->photo) ? $privatescaracts->photo : '');
            $denomination = old('denomination', isset($privatescaracts->denomination) ? $privatescaracts->denomination : '');

            $title = !empty($privatescaracts->denomination) ? $privatescaracts->denomination : 'dealer';
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $address = old('address', isset($privatescaracts->address) ? $privatescaracts->address : '');
        ...
        <div class="col-sm-6">
            <?php
            $address_more = old('address_more', isset($privatescaracts->address_more) ? $privatescaracts->address_more : '');
        ...
        <div class="col-sm-6">
            <?php
            $zip = old('zip', isset($privatescaracts->zip) ? $privatescaracts->zip : '');
        ...
        <div class="col-sm-6">
            <?php
            $city = old('city', isset($privatescaracts->city) ? $privatescaracts->city : '');
        ...
        <div class="col-sm-6">
            <?php
            $province = old('province', isset($privatescaracts->province) ? $privatescaracts->province : '');
        ...
        <div class="col-sm-6">
            <?php
            $region = old('region', isset($privatescaracts->region) ? $privatescaracts->region : '');
        ...
        <div class="col-sm-6">
            <?php
            $subregion = old('subregion', isset($privatescaracts->subregion) ? $privatescaracts->subregion : '');
        ...
        <div class="col-sm-6">
            <?php
            $country_id = old('country_id', isset($privatescaracts->country_id) ? $privatescaracts->country_id : '');
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $phone_1 = old('phone_1', isset($privatescaracts->phone_1) ? $privatescaracts->phone_1 : '');
        ...
        <div class="col-sm-6">
            <?php
            $phone_2 = old('phone_2', isset($privatescaracts->phone_2) ? $privatescaracts->phone_2 : '');
        ...
        <div class="col-sm-6">
            <?php
            $phone_3 = old('phone_3', isset($privatescaracts->phone_3) ? $privatescaracts->phone_3 : '');
        ...
        <div class="col-sm-6">
            <?php
            $phone_mobile = old('phone_mobile', isset($privatescaracts->phone_mobile) ? $privatescaracts->phone_mobile : '');
        ...
        <div class="col-sm-6">
            <?php
            $emails = old('emails', isset($privatescaracts->emails) ? $privatescaracts->emails : Auth::user()->email);
        ...
        <div class="col-sm-6">
            <?php
            $fax = old('fax', isset($privatescaracts->fax) ? $privatescaracts->fax : '');
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $twitter = old('twitter', isset($privatescaracts->twitter) ? $privatescaracts->twitter : '');
            $label_txt = 'Twitter';
            $placeholder = trans('navigation.form_enter_placeholder');
            $attributes = [
                    'data-placeholder' => $placeholder,
        ...
        <div class="col-sm-6">
            <?php
            $facebook = old('facebook', isset($privatescaracts->facebook) ? $privatescaracts->facebook : '');
            $label_txt = 'Facebook';
            $placeholder = trans('navigation.form_enter_placeholder');
            $attributes = [
                    'data-placeholder' => $placeholder,
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $website_url = old('website_url', isset($privatescaracts->website_url) ? $privatescaracts->website_url : '');
        ...
        <div class="col-sm-6">
            <?php
            $rewrite_url = old('rewrite_url', isset($privatescaracts->rewrite_url) ? $privatescaracts->rewrite_url : '');
            $label_txt = 'private url';
            $placeholder = trans('navigation.form_enter_placeholder');
            $attributes = [
                    'data-placeholder' => $placeholder,
                    'placeholder' => $placeholder,
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $opening_time = old('opening_time', isset($privatescaracts->opening_time) ? $privatescaracts->opening_time : '');
        ...
        <div class="col-sm-6">
            <?php
            $legal_informations = old('legal_informations', isset($privatescaracts->legal_informations) ? $privatescaracts->legal_informations : '');
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
            $duns = old('duns', isset($privatescaracts->duns) ? $privatescaracts->duns : '');
            $label_txt = 'Duns';
            ?>
            <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php
            $company_number = old('company_number', isset($privatescaracts->company_number) ? $privatescaracts->company_number : '');
        ...
        <div class="col-sm-6">
            <?php
            $siret = old('siret', isset($privatescaracts->siret) ? $privatescaracts->siret : '');
            $label_txt = 'Siret';
            ?>
            <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php
            $ape = old('ape', isset($privatescaracts->ape) ? $privatescaracts->ape : '');
            $label_txt = 'Ape';
            ?>
            <div class="form-group">
        ...
        <div class="col-sm-6">
            <?php
            $vat = old('vat', isset($privatescaracts->vat) ? $privatescaracts->vat : '');
            $label_txt = 'Vat';
            ?>
            <div class="form-group">
    ...
    @if($isAdmin || 'commercial' == Auth::user()->type)
        <section class="row well well-sm well-white">
            @if($isAdmin)
                <div class="col-sm-6">
                    <?php
                    $origin = old('origin', isset($privatescaracts->origin) ? $privatescaracts->origin : '');
                    $label_txt = 'Origin';
                    ?>
                    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-sm-12 text-center">
            ...
            {!! htmlspecialchars_decode(link_to_route(config('quickadmin.route') . '.privatescaracts.index', '<i class="fa fa-ban fa-fw"></i>' . ucfirst(trans('navigation.cancel')), [], ['class' => 'btn btn-default pull-right'])) !!}
        </div>
    </div>
