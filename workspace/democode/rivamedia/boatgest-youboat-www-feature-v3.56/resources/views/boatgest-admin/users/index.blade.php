...
@section('content')
    ...
    <p>{!! htmlspecialchars_decode(link_to_route('users.create', '<i class="fa fa-plus fa-fw"></i>Add new', [], array('class' => 'btn btn-success'))) !!}</p>
        ...
        <div class="panel-body table-responsive">
            <table class="table table-striped table-hover datatable">
                ...
                @foreach ($users as $user)
                    ...
                    <tr {!! $strike !!}>
                        <td class="{!! $css_status !!}">
                            {!! htmlspecialchars_decode(link_to_route('users.edit', '<i class="fa fa-pencil fa-fw"></i>Edit', [$user->id], ['class' => 'btn btn-block btn-xs btn-primary'])) !!}
                            <br>
                        ...
                        <td class="{!! $css_status !!}">{{ $user->username }}</td>
                        <td class="{!! $css_status !!}">{{ $user->type }}</td>
                        <td class="{!! $css_status !!}">{{ $user->id }}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
