...
<link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/favicon-194x194.png') }}" sizes="194x194">
...
<link rel="mask-icon" href="{{ asset('assets/img/favicons/safari-pinned-tab.svg') }}" color="#2b5797">
<link rel="shortcut icon" href="{{ asset('assets/img/favicons/favicon.ico') }}">
<meta name="apple-mobile-web-app-title" content="BoatGest YouBoat.com">
<meta name="application-name" content="BoatGest YouBoat.com">
