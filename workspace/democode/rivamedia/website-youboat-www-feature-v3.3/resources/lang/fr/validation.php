...
return [
    ...
    */
    ...
    'custom'               => [
        ...
        'g-recaptcha-response' => [
            //'required' => 'Nous avons besoin de vérifier le champ captcha !',
            'required' => 'La case à cocher pour le captacha doit être sélectionnée !',
        ]
    ],
    ...
    */
     ...
     * Recaptcha
     */
    "recaptcha" => 'S\'il vous plaît assurez-vous que vous êtes un être humain!',
    ...
    'attributes'           => [
        ...
        'ci_firstname'         => 'prénom',
        'ci_last_name'          => 'nom',
        'ci_password'           => 'mot de passe',
        'ci_phone'              => 'téléphone',

        'adstypes_id'           => 'type d\'annonce',
        'recovery_adstypes_id'  => 'type d\'annonce de reprise',

        'caracts_labels'        => 'caractéristique titre',
        'caracts_values'        => 'caractéristique valeur',
        'caracts_categories'    => 'caractéristique catégories',
    ],
