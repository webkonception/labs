...
<p>
    ...
    ?>
    {!! trans('sell.email_already_created', ['website_name'=>$website_name, 'login_link'=>$login_link]) !!}
    <br>
    {!! trans('sell.email_lost_password', ['forgotten_password_link'=>$forgotten_password_link]) !!}
    @endif
    </p>

    <hr>
    <h3><u>{!! trans('emails.your_sell_description') !!}:</u></h3>
