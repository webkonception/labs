...
<?php
    if (Auth::check()) {
        $agree_emails = !empty($accountscaracts['agree_emails']) ? $accountscaracts['agree_emails'] : (!empty($datasRequest['agree_emails']) ? $datasRequest['agree_emails'] : null);
        $origin = !empty($accountscaracts['origin']) ? $accountscaracts['origin'] : (!empty($datasRequest['origin']) ? $datasRequest['origin'] : 'YB_Front' . $country_code);
    }
    /*$bod_reference = '';
...
@section('javascript')
    {{--@if($errors->any() || Session::has('errors') || Session::has('message') || Session::has('newsletter_message') || Session::has('account_message'))
...
@section('content')
    ...
    @elseif($errors->any())
        ...
        $message_action = '';
        ?>
        @include('theme.partials.modals.msg-modal', ['form_referrer'=> 'form_account_edit', 'title_modal'=>trans('navigation.boat_on_demand'),'message_modal'=>$message_modal, 'message_action'=>$message_action, 'message_type'=>$message_type])
    @endif

    {{--{!! Form::model($accountscaracts, array('url' => trans_route($currentLocale, 'routes.dashboard_edit_account') . '/' . $accountscaracts->id, 'class' => 'form-horizontal', 'role'=>'form', 'id' => 'form_account_edit', 'autocomplete'=>'off', 'method' => 'PATCH')) !!}--}}
    {!! Form::model($accountscaracts, array('url' => trans_route($currentLocale, 'routes.dashboard_edit_account'), 'class' => 'form-horizontal', 'role'=>'form', 'id' => 'form_account_edit', 'autocomplete'=>'off', 'method' => 'PATCH')) !!}
    {!! Form::hidden('user_id', Auth::user()->id) !!}
    {!! Form::hidden('origin',$origin) !!}
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
                $firstname = old('firstname', isset($accountscaracts->firstname) ? ucwords(mb_strtolower($accountscaracts->firstname)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $name = old('name', isset($accountscaracts->name) ? mb_strtoupper($accountscaracts->name) : '');
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
                $address = old('address', isset($accountscaracts->address) ? ucwords(mb_strtolower($accountscaracts->address)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $address_more = old('address_more', isset($accountscaracts->address_more) ? ucwords(mb_strtolower($accountscaracts->address_more)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $zip = old('zip', isset($accountscaracts->zip) ? $accountscaracts->zip : '');
        ...
        <div class="col-sm-6">
            <?php
                $city = old('city', isset($accountscaracts->city) ? mb_strtoupper($accountscaracts->city) : '');
        ...
        <div class="col-sm-6">
            <?php
                $province = old('province', isset($accountscaracts->province) ? ucwords(mb_strtolower($accountscaracts->province)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $region = old('region', isset($accountscaracts->region) ? ucwords(mb_strtolower($accountscaracts->region)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $subregion = old('subregion', isset($accountscaracts->subregion) ? ucwords(mb_strtolower($accountscaracts->subregion)) : '');
        ...
        <div class="col-sm-6">
            <?php
                $country_id = old('country_id', isset($accountscaracts->country_id) ? $accountscaracts->country_id : '');
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
                $phone_1 = old('phone_1', isset($accountscaracts->phone_1) ? $accountscaracts->phone_1 : '');
        ...
        <div class="col-sm-6">
            <?php
                $phone_mobile = old('phone_mobile', isset($accountscaracts->phone_mobile) ? $accountscaracts->phone_mobile : '');
        ...
        <div class="col-sm-6">
            <?php
                $fax = old('fax', isset($accountscaracts->fax) ? $accountscaracts->fax : '');
        ...
        <div class="col-sm-6">
            <?php
                $emails = old('emails', isset($accountscaracts->emails) ? $accountscaracts->emails : Auth::user()->email);
    ...
    <section class="row well well-sm well-white">
        <div class="col-sm-6">
            <?php
                $twitter = old('twitter', isset($accountscaracts->twitter) ? $accountscaracts->twitter : '');
        ...
        <div class="col-sm-6">
            <?php
                $facebook = old('facebook', isset($accountscaracts->facebook) ? $accountscaracts->facebook : '');
