...
@if(isset($currentRoute) && ('dashboard_edit_ads' == $currentRoute))
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/vendor/jquery.ui.widget.min.js"></script>

    <!-- The Load Image plugin is included for the preview images and image resizing functionality -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-load-image/2.12.2/load-image.all.min.js"></script>

    <!-- The Canvas to Blob plugin is included for image resizing functionality -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/javascript-canvas-to-blob/3.7.0/js/canvas-to-blob.min.js"></script>

    <!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.iframe-transport.min.js"></script>
    <!-- The basic File Upload plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload.min.js"></script>
    <!-- The File Upload processing plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-process.min.js"></script>
    <!-- The File Upload image preview & resize plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-image.min.js"></script>
    <!-- The File Upload audio preview plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-audio.min.js"></script>
    <!-- The File Upload video preview plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-video.min.js"></script>
    <!-- The File Upload validation plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-validate.min.js"></script>

    <!-- The File Upload user interface plugin -->
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/jquery.fileupload-ui.min.js"></script>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.17.0/js/cors/jquery.xdr-transport.min.js"></script>
    <![endif]-->
@endif