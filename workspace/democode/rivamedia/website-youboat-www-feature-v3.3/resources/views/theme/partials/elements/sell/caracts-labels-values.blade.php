<div class="caracts_labels_values">
    <div class="col-sm-4 text-center">{!! Form::label('', $label_caracts_labels, ['class'=>'control-label strong text-primary']) !!}</div>
    <div class="col-sm-2">
    ...
    <div class="col-sm-4 text-center">{!! Form::label('', $label_caracts_values, ['class'=>'control-label strong text-primary']) !!}</div>
    ...
    ?>
        @foreach($inputsCaracts as $k => $v)
            ...
            ?>
            <fieldset id="{!! $caracts_type !!}_{!! $k !!}" class="well {!! $fieldset_state !!}">
                <div class="col-sm-4">
                    <div class="form-group {!! $css_state_label !!}">
                        <input {!! $label_required !!} data-placeholder="{!! $placeholder !!}" placeholder="{!! $placeholder !!}" class="form-control caracts_label"
                               id="{!! $input_name_label . '_' . $k !!}"
                               data-relationship="{!! $caracts_type . '_value_' . $k !!}"
                ...
                <div class="col-sm-4">
                    <div class="form-group {!! $css_state_value !!}">
                        <input {!! $value_required !!} data-placeholder="{!! $placeholder !!}" placeholder="{!! $placeholder !!}" class="form-control caracts_value"
                               id="{!! $input_name_value . '_' . $k !!}"
                               data-relationship="{!! $caracts_type . '_label_' . $k !!}"
