...
<body class="{{ $view_name }} {{ $header_version }}">
    ...
    <div class="body{!! $agent->isMobile() ? ' mobile' : '' !!}{!! $agent->isTablet() ? ' tablet' : '' !!}">
        ...
        {{--@if ( config('youboat.'. $country_code .'.theme.tpl.utility_bar') && !$agent->isMobile() )--}}
        @include('theme.partials.elements.utility-bar', ['view_name'=>$view_name])
        {{--@endif--}}

        @if ('for_sale' === $view_name)
        @include('theme.partials.elements.actions-bar')
        @endif
        ...
        {{--@include('theme.partials.modals.login-modal')--}}
        {{--@if ('for_sale' === $view_name || 'show_ad_detail' === $view_name )--}}
            {{--@include('theme.partials.modals.info-modal')--}}
            {{--@include('theme.partials.modals.offer-modal')--}}
            {{--@include('theme.partials.modals.send-modal')--}}
            {{--@include('theme.partials.modals.testdrive-modal')--}}
        {{--@endif--}}
