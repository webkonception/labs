            ...
            <div class="well row">
                ...
                {!! Form::open(array('url'=>trans_route($currentLocale, 'routes.news_create'), 'class'=>'form', 'id'=>'form_news_create', 'role'=>'form', 'files'=>true)) !!}
                    ...
                    <section class="row">
                        <div class="col-sm-6">
                            <?php
                            $label_txt = trans('news.author') . ' ' . ucfirst(trans('validation.attributes.name'));
                        ...
                        <div class="col-sm-6">
                            <?php
                            $label_txt = trans('news.author') . ' ' . ucfirst(trans('validation.attributes.email'));
                            $placeholder = trans('navigation.form_enter_placeholder');
                        ...
                        <div class="col-sm-6">
                            <?php
                            $label_txt = trans('news.author') . ' ' . ucfirst(trans('validation.attributes.phone'));
                            $placeholder = trans('navigation.form_enter_placeholder');
                        ...
                        <div class="col-sm-6">
                            <?php
                            $label_txt = trans('news.author') . ' ' . 'URL';
                            $placeholder = trans('navigation.form_enter_placeholder');
