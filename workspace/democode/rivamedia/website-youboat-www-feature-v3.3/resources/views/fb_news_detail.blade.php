...
<?php
    ...
    $photo = thumbnail(asset($photo), 337, 228, false, false, true, 100);
?>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="col-sm-12 well well-white">
                ...
                <a href="{!! config('youboat.' . $country_code . '.facebook') !!}" class="blank">
                ...
                @include('theme.partials.elements.block.fb-page-block', [])
            </div>
            <div class="col-sm-12 well well-white">
                <h3>{!! trans('contact.title_tweet') !!}</h3>
                <a href="{!! config('youboat.' . $country_code . '.twitter') !!}" class="blank">
                    <span class="fa-stack fa-lg">
                      <i class="fa fa-square-o fa-stack-2x"></i>
