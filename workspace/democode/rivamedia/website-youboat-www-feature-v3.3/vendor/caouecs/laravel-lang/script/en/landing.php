...
return [
    ...
    'landing_text_01' => '<strong>Youboat</strong> is your solution for finding the right boat, no matter where you are. <br>Our mission at <strong>Youboat</strong> is to be your ultimate online solution for buying and selling new, certified and used boats.',
    ...
    'landing_text_02' => 'Our website has been designed in order to give you more control through the buying process, finding your boat will be one click away. <br>We want your searching experience to be as easy as possible.',
    ...
    'landing_text_03' => 'Thanks to our extremely specialized and improved search engine, you will easily find the perfect boat whether it is a new or used one.',
    ...
    'landing_text_07' => 'Unique in Europe, <strong>Youboat</strong> uses a unique system entitled: <strong>Boat on Demand!</strong> <br><br>Boat on Demand llists <strong>&laquo;Wanted&raquo;</strong> ads. <br><br>Buyers can create adverts describing their requirements, and it’s free of charge! <br><br>Private and trader sellers can search <strong>&laquo;Wanted&raquo;</strong> ads and  contact the relevant buyers directly.',
